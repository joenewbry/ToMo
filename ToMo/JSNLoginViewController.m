...
#import "JSNLoginViewController.h"
#import "JSNEmailLoginOrSignUpViewController.h"

@interface JSNLoginViewController ()

@end

@implementation JSNLoginViewController
...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender
{
    ...
    if ([destinationViewController isKindOfClass:[JSNEmailLoginOrSignUpViewController class]]) {
        ...
        emailLoginOrSignUpViewController.submitButtonTitleText = @"Log in";
    }
}
